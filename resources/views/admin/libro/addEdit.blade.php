                ...
                <div class="bg-white rounded-xl sm:p-10">
                    <div class="grid lg:gap-x-10 lg:grid-cols-12 lg:gap-y-8 grid-cols-1">
                        <div class="relative hidden lg:col-span-5 lg:block">
                            ...
                            <div>
                                <label for="image" class="absolute w-10 h-10 top-0 m-2 flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    <i class="fa-solid fa-pen"></i>
                                </label>
                                <input id="image" name="image" type="file" class="hidden form-control">
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="grid gap-6 md:grid-cols-2">
                                    <div class="w-full mt-0 mr-auto mb-3 ml-auto">
                                        ...
                                        <div class="mt-1 mr-0 mb-0 ml-0">
                                            <input type="number" min="1" placeholder="1" class="p-2.5 focus:ring-indigo-500 focus:border-indigo-500
                                                sm:text-sm w-full block h-10 border-gray-300 border shadow-sm rounded-md"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full mt-0 mr-auto mb-4 ml-auto">
                                        ...
                                        <div class="mt-1 mr-0 mb-0 ml-0">
                                            <select class="p-2.5 focus:ring-indigo-500 focus:border-indigo-500
                                                sm:text-sm w-full block h-10 border-gray-300 border shadow-sm rounded-md">
                                                <option selected value="{{ $clasificaciones[0]->id }}">{{ $clasificaciones[0]->clasificacion }}</option>
                                                @for($i = 1; $i < count($clasificaciones); $i++)
                                                    <option value="{{ $clasificaciones[$i]->id }}">{{ $clasificaciones[$i]->clasificacion }}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="grid gap-6 md:grid-cols-2">
                                    <div class="w-full mt-0 mr-auto mb-3 ml-auto">
                                        ...
                                        <div class="mt-1 mr-0 mb-0 ml-0">
                                            <input type="number" max='{{ now()->year }}' placeholder='{{ now()->year }}' class="p-2.5 focus:ring-indigo-500 focus:border-indigo-500
                                                sm:text-sm w-full block h-10 border-gray-300 border shadow-sm rounded-md"/>
                                        </div>
                                    </div>
                                    ...
                                    w-full text-center">Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
